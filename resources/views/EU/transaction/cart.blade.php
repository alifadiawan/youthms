                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-9 col-md-6 mb-4 mb-lg-0">
                                    <p><strong>Feed Instagram</strong></p>
                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-9 col-md-6 mb-4 mb-lg-0 align-items-center">
                                    <p><strong>Landing Page Laravel</strong></p>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a type="button" href="/pembayaran" id="checkout" class="btn btn-success btn-lg btn-block" style="display: ">
                                Go to checkout
                            </a>
