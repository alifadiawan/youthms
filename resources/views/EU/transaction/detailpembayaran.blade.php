    ...
    @section('content')
        {{-- <div id="container" class="container my-5" style="max-width: 50rem">
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    @if ($pembayaran->request_user_id != null)
                                        <h5 class="h3 mb-0 text-uppercase fw-bold me-auto text-warning font-weight-bold">kredit
                                        </h5>
                                    @endif
                                    @if ($pembayaran->status == 'checking')
                                        <h5 class="h3 mb-0 text-uppercase fw-bold me-auto text-warning font-weight-bold"><i class="fa-solid fa-circle-notch fa-spin fa-xl"></i> {{ $pembayaran->status }}
                                        </h5>
                                    @else
                                        <h5 class="h3 mb-0 text-uppercase fw-bold me-auto text-success font-weight-bold">{{ $pembayaran->status }}
                                        </h5>
                                    @endif
                            ...
                            <div class="konten">
                                    ...
                                    <div class="col text-center">
                                        ...
                                        @else
                                            <h5
                                                ...
                                                <i class="fa-regular fa-circle-check fa-bounce"></i> {{ $pembayaran->status }}
                                            </h5>
                                        @endif
                                        <p class="text-muted">
                                ...
                                <div class="penerima">
                                    <div class="row">
                                        ...
                                        <div class="col-12 text-center">
                                            <img class="img-fluid" src="{{ asset('bukti_transfer/' . $pembayaran->bukti_tf) }}"
                                                alt="">
                                        </div>
                                    </div>
