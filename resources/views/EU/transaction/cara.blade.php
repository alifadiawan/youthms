                                    ...
                                    <div class="card-body">
                                        <span class="text-dark" style="font-size: 16px; line-height:normal">
                                            ...
                                            <ol>
                                                ...
                                                <li>Periksa kembali informasi mengenai transaksi Anda. pastikan nomor
                                                    rekening dan nama penerima sudah sesuai. Lalu, klik Transfer.</li>
                                ...
                                @foreach ($transaksi as $t)
                                    <div class="d-flex flex-column px-md-5 px-4 mb-4"> <span>Nominal Yang Harus
                                        ...
                                        <div class="inputWithIcon"> <input class="form-control text-uppercase"
                                                type="text"
                                                value="IDR. {{ number_format($t->total - $t->total_bayar, 0, ',', '.') }}">
    ...
    <div class="modal fade" id="modalKonfirmasi" tabindex="-1" aria-labelledby="modalKonfirmasi" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('pembayaran.store') }}" onsubmit="    validate()" method="POST"
                        ...
                        @foreach ($transaksi as $t)
                            ...
                            <div>
                                <label for="" class="mt-3">Bukti Pembayaran (Struk / Screenshoot
                                    Transfer)</label>
                                <input type="file" class="form-control mt-2" name="bukti" id="bukti" accept="image/*">
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" data-bs-toggle="modal">Kirim Bukti</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-confirm">
            <div class="modal-content">
                <div class="modal-header justify-content-center">
                    <div class="icon-box">
                        <lottie-player src="https://lottie.host/898883ab-e21d-4779-9364-24e401afe38d/Q5YrvLU3Pm.json"
                ...
                <div class="modal-body text-center">
                    <h4 class="text-danger fw-bold">Warning !</h4>
                    <p>Konfirmasi Pembayaran Gagal !!!<br><span class="fw-bold">Silahkan upload bukti transfer
                            pembayaran</span></p>
                    <a href="" class="btn btn-sm btn-danger uppercase">Ulangi Konfirmasi</a>
                    {{--   --}}
                </div>
            </div>
        </div>
