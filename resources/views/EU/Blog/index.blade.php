                                ...
                                <div class="card-body" style="">
                                    ...
                                    <div class="header container mb-2 mt-3">
                                        <div class="d-flex flex-row text-center gap-3" style="justify-content: center">
                                            <a href="" class="btn yms-outline-blue rounded-5" style="width:70px; height:100%"><i class="fa-solid fa-star"></i></a>
                                            <a href="" class="btn yms-outline-blue rounded-5" style="width:70px; height:100%"><i class="fa-solid fa-chart-simple"></i></a>
                                            <a href="" class="btn yms-outline-blue rounded-5" style="width:70px; height:100%"><i class="fa-regular fa-hand-pointer"></i></a>
