                                        ...
                                        <div class="col-lg-4" style="margin-top: 50px">
                                            <div class="single-bottom mb-35">
                                                ...
                                                <div class="trend-bottom-cap">
                                                    ...
                                                    <h4><a
                                                            href="{{ route('blogs.detail', $ru->id) }}">{{ $ru->judul }}</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4" style="margin-top: 50px">
                                            <div class="single-bottom mb-35">
                                                ...
                                                <div class="trend-bottom-cap">
                                                    ...
                                                    <h4><a
                                                            href="{{ route('blogs.detail', $rl->id) }}">{{ $rl->judul }}</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="header container mb-2 mt-3">
                                        <div class="d-flex flex-row text-center gap-3" style="justify-content: center">
                                            <a type="submit" href="#" onclick="show('populer')"
                                                class="btn-populer rounded-5" style="width:70px; height:100%"><i
                                                    class="fa-solid fa-star"></i></a>
                                            <a type="submit" href="#" onclick="show('weekly')"
                                                class="btn-terkini rounded-5" style="width:70px; height:100%"><i
                                            ...
                                            @foreach ($populer as $p)
                                                <div class="trand-right-single d-flex">
                                                    ...
                                                    <div class="trand-right-cap">
                                                        ...
                                                        <h4><a
                                                                href="{{ route('blogs.detail', $p->id) }}">{{ $p->judul }}</a>
                                                        </h4>
                                                    </div>
                                                </div>
                                            @endforeach
