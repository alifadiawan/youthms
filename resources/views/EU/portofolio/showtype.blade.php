...
@section('content')
    ...
    <section id="hero-portofolio" class="hero-portofolio d-flex align-items-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-6 col-12 align-items-center" data-aos="zoom-in" data-aos-delay="200">
                    {{-- @foreach ($ills as $i)
                ...
                <div class="col-lg-7 col-md-6 col-12 d-flex flex-column justify-content-start pt-4 pt-lg-0" data-aos="fade-up"
                    data-aos-delay="200">
                    @foreach ($ills as $i)
                        <h1>{{ $i->text_head }}</h1>
                        <p>{{ $i->text_body }}</p>
