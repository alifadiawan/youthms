            ...
            @auth
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('cart.index') }}">
                        ...
                        @else
                        <i class="fa-solid fa-cart-shopping fa-lg"><span class="qty posisition-absolute badge bg-danger position-absolute top-0 translate-middle badge rounded-pill">{{ $badge->count() }}</span></i>
                        @endif
                    </a>
                </li>
